...
function formatDateTime(dateVal: string | Date): string {
  try {
...
export function MessageManager({
  ...
  return (
    <div className="space-y-4 max-w-full overflow-x-hidden p-4 sm:p-6 bg-slate-50 min-h-screen text-slate-900">
      {/* 1. HEADER */}
        ...
        <CardContent className="pt-4">
          {filteredMessages.length === 0 ? (
            <div className="p-8 text-center border border-dashed border-slate-200 rounded-2xl bg-slate-50/50 space-y-2">
              <div className="w-10 h-10 rounded-full bg-blue-50 text-blue-600 border border-blue-100 flex items-center justify-center mx-auto font-bold">
