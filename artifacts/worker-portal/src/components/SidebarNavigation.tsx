...
export function SidebarNavigation({
  ...
  return (
    <>
      ...
      {/* ==================== SIDEBAR CONTAINER ==================== */}
      <aside
        className={`fixed md:sticky top-0 left-0 z-50 h-screen bg-white border-r border-blue-100 shadow-xl md:shadow-none flex flex-col justify-between transition-all duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="p-3.5 sm:p-4 border-b border-blue-50 flex items-center justify-between bg-gradient-to-r from-blue-50/60 to-indigo-50/40">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-9 h-9 rounded-2xl bg-blue-600 text-white font-black flex items-center justify-center text-sm shadow-md shadow-blue-500/20 shrink-0">
            ...
            {(!isCollapsedDesktop || isOpenMobile) && (
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[10px] text-blue-600 font-bold truncate mt-0.5">
          ...
          <button
            type="button"
            onClick={onCloseMobile}
            className="md:hidden p-1.5 rounded-xl text-slate-500 hover:text-slate-900 hover:bg-blue-50 transition-colors focus:outline-none min-h-[44px] min-w-[44px] flex items-center justify-center"
            title="Tutup Menu"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <button
            ...
            className="hidden md:flex p-1.5 rounded-xl text-slate-400 hover:text-blue-600 hover:bg-blue-50 transition-colors focus:outline-none"
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-2xl text-xs font-bold transition-all min-h-[44px] group relative ${
                  isActive
              ...
              >
                ...
                {(!isCollapsedDesktop || isOpenMobile) && item.badge && !isActive && (
                  <Badge
                    variant="outline"
                    className="text-[9px] bg-blue-50 text-blue-700 border-blue-200 font-bold px-1.5 py-0 shrink-0 rounded-full"
                  >
                    {item.badge}
                  </Badge>
                )}
        ...
        <div className="p-3 border-t border-blue-50 bg-slate-50/60 space-y-2">
          {(!isCollapsedDesktop || isOpenMobile) ? (
            <div className="space-y-2">
              <div className="flex items-center gap-2.5 p-2.5 rounded-2xl bg-white border border-blue-100 shadow-xs">
                <div className="w-8 h-8 rounded-xl bg-blue-600 text-white font-black flex items-center justify-center text-xs shadow-xs shrink-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-1 text-[10px] text-slate-500">
                    ...
                    <button
                      ...
                      className="text-slate-400 hover:text-blue-600 p-0.5 rounded focus:outline-none shrink-0"
                  ...
                  <div className="mt-0.5 flex items-center gap-1">
                    <Badge variant="outline" className="text-[9px] bg-blue-50 text-blue-800 border-blue-200 font-bold px-1.5 py-0 rounded-full">
              ...
              <Button
                variant="outline"
                onClick={onLogout}
                className="w-full h-9 min-h-[44px] sm:min-h-[36px] bg-white hover:bg-rose-50 border-slate-200 hover:border-rose-200 text-rose-600 hover:text-rose-700 font-bold text-xs gap-2 rounded-xl transition-colors shadow-2xs"
              >
            ...
            <div className="flex flex-col items-center space-y-2">
              <div
                className="w-8 h-8 rounded-xl bg-blue-600 text-white font-black flex items-center justify-center text-xs shadow-xs"
