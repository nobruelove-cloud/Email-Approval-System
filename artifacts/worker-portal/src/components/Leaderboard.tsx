          ...
          <CardContent className="p-4 sm:p-5 space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-sm ring-2 ring-blue-400/30">
                  <Crown className="w-5 h-5 text-blue-100" />
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-bold text-blue-300 uppercase tracking-wider">Peringkat Anda saat ini</span>
                    <Badge className="bg-blue-500/20 text-blue-200 border-blue-400/30 text-[10px] font-bold">
                      Global Rank
                    </Badge>
                  </div>
                  <p className="text-xl sm:text-2xl font-black text-white tracking-tight">
                    {userProgressInfo.positionText}
                    <span className="text-xs text-blue-200/80 font-normal ml-2">
              ...
              <div className="text-left sm:text-right">
                <span className="text-[11px] text-blue-300 font-medium block">Target Berikutnya</span>
            ...
            <div className="space-y-1.5 pt-1">
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="text-blue-300 font-bold">{userProgressInfo.progressPercent}%</span>
              </div>
              <div className="w-full bg-slate-800/90 h-3 rounded-full overflow-hidden border border-blue-500/30 p-0.5">
                <div
                  className="bg-gradient-to-r from-blue-500 via-orange-500 to-blue-400 h-full rounded-full transition-all duration-500 shadow-[0_0_12px_rgba(245,158,11,0.6)]"
