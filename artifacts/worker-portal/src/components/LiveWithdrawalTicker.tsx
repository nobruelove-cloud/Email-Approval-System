...
const SAMPLE_PAYMENTS: PaymentEntry[] = [
  ...
  { id: "5", worker: "@dewi_a***", amount: "Rp 12.500", method: "DANA", timeAgo: "18m lalu" },
  ...
  { id: "8", worker: "@andri_w***", amount: "Rp 16.000", method: "GoPay", timeAgo: "34m lalu" },
  { id: "9", worker: "@bayu_r***", amount: "Rp 18.000", method: "ShopeePay", timeAgo: "41m lalu" },
  { id: "10", worker: "@hendra_k***", amount: "Rp 10.000", method: "ShopeePay", timeAgo: "47m lalu" },
