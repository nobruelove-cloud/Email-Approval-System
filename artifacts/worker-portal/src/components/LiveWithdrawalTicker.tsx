...
const SAMPLE_PAYMENTS: PaymentEntry[] = [
  { id: "1", worker: "@dimas_p***", amount: "Rp 50.000", method: "DANA", timeAgo: "3m lalu" },
  { id: "2", worker: "@fajar_a***", amount: "Rp 100.000", method: "OVO", timeAgo: "7m lalu" },
  { id: "3", worker: "@rizky_k***", amount: "Rp 35.000", method: "GoPay", timeAgo: "12m lalu" },
  { id: "4", worker: "@m_fauzi***", amount: "Rp 75.000", method: "ShopeePay", timeAgo: "18m lalu" },
  { id: "5", worker: "@budi_s***", amount: "Rp 150.000", method: "Bank BCA", timeAgo: "24m lalu" },
  { id: "6", worker: "@dewi_a***", amount: "Rp 50.000", method: "DANA", timeAgo: "31m lalu" },
  { id: "7", worker: "@andri_w***", amount: "Rp 120.000", method: "Bank BRI", timeAgo: "38m lalu" },
  { id: "8", worker: "@siti_m***", amount: "Rp 45.000", method: "GoPay", timeAgo: "45m lalu" },
  { id: "9", worker: "@bayu_r***", amount: "Rp 80.000", method: "OVO", timeAgo: "52m lalu" },
  { id: "10", worker: "@hendra_k***", amount: "Rp 200.000", method: "Bank Mandiri", timeAgo: "1j lalu" },
];
